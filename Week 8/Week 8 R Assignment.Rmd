...
My maching took about 53 seconds to do 100,000 loops of 100 Flips. This is my work computer and it's relatively new so I think that's pretty fast.  

I figure I'd put 20 trails of 100,000 tests to see if we're converging onto a number - basically, I just threw <i>another loop</i> around the above one and put the resutls into another vector :-)

Then to make thins a little nicer to see, I put a simple data.frame together to show to results, number of tests and the probability.
...
{
  Seven.Tests.Num <- 100 # In actuality, I did this with 100,000 but didn't want the 'Knit HTML' to take too long so limited this to 100 for the RMarkdown.  Results below are based on 100,000
  Seven.Tests <- c(1:Seven.Tests.Num)*0
